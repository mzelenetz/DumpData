...
FROM EDM.INPATIENTS@EDWPROD i
       ...
       --LEFT JOIN EDM.INPATIENTSCENSUS@EDWPROD cen2 ON cen2.PATIENTID = i.PATIENTID AND cen2.mrn = i.mrn AND cen2.FACILITYID = i.FACILITYID AND TRUNC(cen2.TRANSFERINDATETIME) = TRUNC(i.ADMITTED) 
       LEFT JOIN EDM.LOOKUPFACILITY@EDWPROD fac ON fac.facilityid = i.facilityid
       LEFT JOIN EDM.LOOKUPPROVIDER@EDWPROD prov ON prov.PROVIDERID = i.ADMITATTENDID
